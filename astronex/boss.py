# -*- coding: utf-8 -*-
from astronex.gui.mainnb import MainPanel, Slot
from astronex.zodiac import Zodiac
...
boss = None
import pickle
from astronex.directions import solar_rev, sec_prog
...
class Manager(object):
    ...
    def __init__(self,app,opts,state):
        ...
        try:
            with open('astronex/resources/ac.pk', 'rb') as f:
                self.acpaths = pickle.load(f)
        except Exception as e:
            print("Aviso: no se pudo cargar ac.pk (%s). acpaths queda vacio." % e)
            self.acpaths = {}
    ...
    def set_mainwin(self,mainwin):
        ...
        self.da.drawer.hoff = alloc.width * 0.125
