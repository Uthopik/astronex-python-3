...
from astronex.drawing.roundedcharts import RadixChart, NodalChart
...
class CoreMixin(object):
    ...
    def draw_double_cusp(self,cr,radius,chartob):
        ...
        clickmode = _boss().state.clickmode
        cr.save()
        #lw = cr.get_line_width()
